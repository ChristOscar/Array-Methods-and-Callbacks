...
function getFinals(data) {
   /* code here */
   const finalM = data.filter(item => item.Stage === 'Final');
   return finalM;
}
...
function getYears(data, getFinalsCB) {
    /* code here */
    const gYears = getFinalsCB(data).map(item => item.Year);
    return gYears;
}
...
function getWinners(data, getFinalsCB) {
    /* code here */
    const winners = getFinalsCB(data).map(item => item['Home Team Goals'] > item['Away Team Goals'] ?
